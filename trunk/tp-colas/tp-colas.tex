...
\paragraph{Ejercicio 8}
   ...
   Puede obtenerse la siguiente expresión:
      $$\sum_{n=0}^{\inf} p(n) = 1 = p(0) + p(1) + \sum_{n=2}^{\inf} p(n)$$
      $$1 = p(0) + p(0) \lambda / \mu + \sum_{n=2}^{\inf} p(0) (\frac{\lambda + 0.1 \mu}{\mu})^{n-2} \lambda / \mu$$
      $$1 = p(0) + p(0) \lambda / \mu + p(0) \lambda / \mu \sum_{n=0}^{\inf} (\frac{\lambda + 0.1 \mu}{\mu})^n$$
   ...
   \paragraph{8.a.} La cantidad promedio de clientes en la cola es $L_{craya}$.
      $$L_{craya} = L_{raya} - (1 - P(0))$$
      $$L_{raya} = \sum_{n=0}^{\inf} n p(n) = 0 p(0) + 1 p(1) + \sum_{n=2}^{\inf} n p(n)$$
      $$... = 8/10 p(0) + \sum_{n=1}^{\inf} n p(0) (\frac{\lambda + 0.1 \mu}{\mu})^n$$

      Sabiendo que, $\rho < 1 \Rightarrow \sum_{n=0}^{\inf} n \rho^n = \frac{\rho}{(1- \rho)^2}$
      $$L_{raya} = 8/10 p(0) + p(0) \frac{\frac{\lambda + 0.1 \mu}{\mu}}{(1 - \frac{\lambda + 0.1 \mu}{\mu})^2}$$
      $$... = 8/10 p(0) + p(0) \frac{9/10}{1/10^2}$$
      $$... = 8/10 p(0) + p(0) 90$$
      $$... = 8/10 (10/98) + (10/98) 90$$
      $$\Rightarrow L_{raya} \simeq 9.265$$

      Por lo tanto: $L_{craya} \simeq 9.265 - (1-10/98) \simeq 8.3673$ clientes.


   \paragraph{8.b.} El tiempo promedio de permanencia de un cliente en la cola es $W_c$.
      $$W_c = \frac{L_c}{\lambda_{raya}}$$
      $$\lambda_{raya} = \sum_{n=0}^{\inf} \lambda_n p(n) = p(0) \lambda + \sum_{n=1}^{\inf} p(n) (\lambda + 0.1 \mu) $$
      $$... = p(0) \lambda + (1 - p(0)) (\lambda + 0.1 \mu) $$
      $$... = (10/98) 8 + (88/98) 9$$
      $$\Rightarrow \lambda_{raya} = 872/98 \simeq 8.898$$
...
% TODO (mmazzei) - Reemplazar \*_{raya} por el símbolo que dibuja la barra de promedio encima del caracter.
%       * L_{craya}      --> L_c raya
%       * L_{raya}       --> L   raya
%       * \lambda_{raya} --> lambda raya
% TODO (mmazzei) - Reemplazar \inf por el símbolo que dibuja +infinito.
\end{document}
