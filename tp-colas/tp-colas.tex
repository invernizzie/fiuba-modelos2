...
\paragraph{Ejercicio 6}
    ...
    $$L_c = \sum_{n=0}^{4}L_c(n) p(n) = 1 p(3) + 2 p(4) = \frac{2250}{3321} \simeq 0,68 $$
    ...
    $$ \Rightarrow \overline{R} = 5 - \frac{1220}{369} \simeq 1.69$$
    ...
    $$ \overline{\lambda} = \sum_{n=0}^{4}\lambda(n) p(n) = \lambda [ p(0)+p(1)+p(2) ] + \frac{\lambda}{2} p(3) = \frac{1220}{369} \simeq 3.31$$
